...
RegisterNetEvent('seatbelt:client:UseHarness', function(ItemData) -- On Item Use (registered server side)
    ...
    if inveh and class ~= 8 and class ~= 13 and class ~= 14 then
        if not harnessOn then
            ...
            QBCore.Functions.Progressbar("harness_equip", "Anbringen des Renngurtes", 5000, false, true, {
            ...
            LocalPlayer.state:set("inv_busy", true, true)
            QBCore.Functions.Progressbar("harness_equip", "Abnehmen des Renngurtes", 5000, false, true, {
                disableMovement = false,
                disableCarMovement = false,
                disableMouse = false,
                disableCombat = true,
        ...
        QBCore.Functions.Notify('Du bist nicht in einem Auto.', 'error')
    end
end)
