                ...
                if prevPos ~= nil then
                    if currentPos == prevPos then
                        if time ~= nil then
                            if time > 0 then
                                if time == (900) then
                                    QBCore.Functions.Notify('Du bist AFK und wirst rausgeschmissen ' .. math.ceil(time / 60) .. ' Minuten!', 'error', 10000)
                                ...
                                elseif time == (60) then
                                    QBCore.Functions.Notify('Du bist AFK und wirst rausgeschmissen ' .. math.ceil(time / 60) .. ' Minuten!', 'error', 10000)
                                elseif time == (30) then
                                    QBCore.Functions.Notify('Du bist AFK und wirst rausgeschmissen ' .. time .. ' Sekunden!', 'error', 10000)
                                elseif time == (20) then
                                    QBCore.Functions.Notify('Du bist AFK und wirst rausgeschmissen ' .. time .. ' Sekunden!', 'error', 10000)
                                elseif time == (10) then
                                    QBCore.Functions.Notify('Du bist AFK und wirst rausgeschmissen ' .. time .. ' Sekunden!', 'error', 10000)
